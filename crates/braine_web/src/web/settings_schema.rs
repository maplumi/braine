...
pub fn param_specs() -> Vec<ParamSpec> {
    ...
    vec![
        ...
        ParamSpec {
            key: "phase_coupling_gain",
            label: "Phase Coupling Gain",
            section: ParamSection::Dynamics,
            description: "Multiplier for phase coupling influence on oscillator dynamics. Decouples phase synchronization strength from amplitude weights for independent tuning.",
            units: None,
            min: 0.0,
            max: 2.0,
            step: 0.01,
            default: d.phase_coupling_gain,
            recommended: Some(RecommendedRange { min: 0.1, max: 1.0 }),
            when_to_change: "Reduce if phase locking interferes with amplitude dynamics or causes instability; increase if temporal binding needs strengthening.",
            risk: Risk::Medium,
            advanced: true,
        },
        ParamSpec {
            key: "phase_coupling_mode",
            label: "Phase Coupling Mode",
            section: ParamSection::Dynamics,
            description: "Function for phase coupling: 0=linear (legacy), 1=sinusoidal, 2=tanh saturating. Controls how phase differences affect synchronization.",
            units: None,
            min: 0.0,
            max: 2.0,
            step: 1.0,
            default: d.phase_coupling_mode as f32,
            recommended: Some(RecommendedRange { min: 1.0, max: 2.0 }),
            when_to_change: "Switch to 1 or 2 for bounded coupling that prevents runaway phase attraction; use 0 for legacy behavior.",
            risk: Risk::Medium,
            advanced: true,
        },
        ParamSpec {
            key: "phase_coupling_k",
            label: "Phase Coupling Strength (k)",
            section: ParamSection::Dynamics,
            description: "Strength parameter for tanh phase coupling (mode 2). Higher values make coupling more aggressive near zero phase difference.",
            units: None,
            min: 0.0,
            max: 10.0,
            step: 0.1,
            default: d.phase_coupling_k,
            recommended: Some(RecommendedRange { min: 1.0, max: 5.0 }),
            when_to_change: "Increase for sharper phase locking; decrease for gentler synchronization.",
            risk: Risk::Medium,
            advanced: true,
        },
        ParamSpec {
