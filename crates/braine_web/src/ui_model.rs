...
impl GameKind {
    ...
    pub fn inputs_info(self) -> &'static str {
        match self {
            ...
            GameKind::Maze => "Base stimulus: maze (context)\nSensors: maze_wall_{up,right,down,left}, maze_goal_{left,right,up,down,here}, maze_dist_b0..b3, maze_mode_{easy,medium,hard}, maze_bump, maze_reached_goal\nStimulus key: maze_<difficulty>_w<mask>_<dx><dy>_b<bucket>\nActions: up, right, down, left\nAction labels (causal graph): pair::<stimulus_key>::<action>",
